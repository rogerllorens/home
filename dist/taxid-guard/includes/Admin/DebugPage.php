...
final class DebugPage
{
    ...
    public function render(): void
    {
        ...
        $blocksFieldFn = function_exists('woocommerce_register_additional_checkout_field');
        $data = [
            ...
            'checkout_blocks_detected' => in_array(Bootstrap::instance()->debug_checkout_context(), ['checkout_block', 'fse_blocks', 'store_api_rest'], true) ? 'yes' : 'no',
            'blocks_additional_fields_api' => $blocksFieldFn ? 'yes' : 'no',
        ];

...
export function RealUploadPage() {
  ...
  async function handleFile(event: ChangeEvent<HTMLInputElement>) {
    ...
    setBusy("reading");
    try {
      const catalog = await parseImportPreview({ buffer: await selected.arrayBuffer(), fileName: selected.name, mime: selected.type });

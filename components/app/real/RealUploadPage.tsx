...
export function RealUploadPage() {
  ...
  async function createJob() {
    ...
    try {
      ...
      showToast("Job creado. El worker usará IA real si hay provider configurado y fallback seguro si falla.", "success");

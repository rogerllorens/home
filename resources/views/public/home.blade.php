...
<x-layouts.public title="{{ $pageTitle }}">
    ...
    <section class="mb-8 rounded-xl border border-red-600/40 bg-black/80 p-5 md:p-6">
        <div class="grid gap-6 lg:grid-cols-[1.1fr,1fr] lg:items-center">
            <div class="space-y-5">
                ...
                <p class="text-sm text-slate-300 md:text-base">Videos auténticos, curados a diario para que empieces a ver en segundos.</p>
    ...
    @if ($continueWatching->isNotEmpty())
        <section class="mb-10">
            <div class="mb-3 flex items-center justify-between">
                ...
                <span class="text-xs text-slate-400">Your recent videos</span>
            </div>
            <x-video-grid>
    ...
    @if ($trendingVideos->isNotEmpty())
        <section class="mb-10">
            <div class="mb-3 flex items-center justify-between">
                ...
                <span class="text-xs text-slate-400">Most viewed this week</span>
            </div>
            <x-video-grid>
    ...
    @if ($newThisWeek->isNotEmpty())
        <section class="mb-10">
            <div class="mb-3 flex items-center justify-between">
                <h2 class="text-lg font-semibold text-white">New this week</h2>
                <span class="text-xs text-slate-400">Freshly published</span>
            </div>
            <x-video-grid>

    ...
    <section class="grid gap-8 lg:grid-cols-3">
        <div class="lg:col-span-2">
            ...
            <div class="mt-6 space-y-6">
                ...
                <div class="space-y-2">
                    <h1 class="text-2xl font-semibold text-white leading-tight">{{ $video->title }}</h1>
                ...
                @if ($ctas)
                    <div class="rounded-md border border-red-500/30 bg-red-500/10 p-4">
                        ...
                        <div class="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            @foreach ($ctas as $cta)
                                <a
                                    class="flex flex-col justify-between rounded-md border border-red-500/40 bg-red-600/20 px-4 py-3 text-sm font-semibold text-white hover:bg-red-600/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
                                    href="{{ $cta['track_url'] }}"
                                    target="_blank"
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm">
                    ...
                    @endif
                    @if ($nextVideo)
                        <a class="rounded-md border border-red-500/60 px-3 py-2 font-semibold text-red-100 hover:border-red-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950" href="{{ route('public.video', ['slug' => \Illuminate\Support\Str::slug($nextVideo->seo_title ?: $nextVideo->title), 'id' => $nextVideo->id]) }}">
                            Next video
                        </a>
                    @endif
                    @if ($shuffleVideo)
                        <a class="rounded-md bg-white/5 px-3 py-2 font-semibold text-slate-100 hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950" href="{{ route('public.video', ['slug' => \Illuminate\Support\Str::slug($shuffleVideo->seo_title ?: $shuffleVideo->title), 'id' => $shuffleVideo->id]) }}">
                            Shuffle
                        </a>
                    @endif
                </div>

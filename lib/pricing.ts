...
export const SUBSCRIPTION_PLANS = [
  ...
  { id: "starter", name: "Starter", price: "19 €/mes", monthlyProducts: 50, featured: false, ideal: "Tiendas pequeñas", equivalent: "50 estándar · 25 Pro · 12 Premium aprox.", features: ["50 productos estándar/mes", "Importación Excel/CSV", "Export CSV básico", "Metas, slug, descripción HTML", "3 FAQs y schema básico"] },

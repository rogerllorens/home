...
export async function saveFreeSeoAudit(result: FreeSeoAuditResult, context: { userId?: string | null; leadEmail?: string | null; sourceIp?: string | null; userAgent?: string | null }) {
  ...
  const payload = {
    ...
    schema_score: result.schema_advanced?.schema_score ?? null,
    ...
    geo_aeo_score: result.geo_aeo_advanced?.geo_aeo_score ?? null,

...
export type ImportedCatalog = { sourceType: ImportSourceType; sheets?: WorkbookSheetSummary[]; fileName?: string; sheetName?: string | null; encoding?: string | null; delimiter?: string | null; platformGuess?: PlatformGuess; headers: string[]; rows: ImportedCatalogRow[]; sampleRows: ImportedCatalogRow[]; mappingSuggestions: MappingSuggestion[]; stats: ImportStats; warnings: ImportWarning[]; errors: ImportError[] };

...
const groups: EnvGroup[] = [
  ...
  { name: "pagespeed", required: [], recommended: ["PAGESPEED_API_KEY", "PAGESPEED_ENABLED", "PAGESPEED_TIMEOUT_MS", "PAGESPEED_CACHE_TTL_HOURS", "PAGESPEED_MAX_URLS_PER_DAY"] },
];
...
if (process.env.PAGESPEED_ENABLED !== "false" && !process.env.PAGESPEED_API_KEY) {
  const level = strict ? "ERROR" : "WARN";
